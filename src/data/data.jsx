export const data = {
  "project": [
    ...
    },
    {
      ...
      "description": "This is an Instagram clone built using HTML, CSS, JavaScript, and Bootstrap. The main focus of this project was to replicate the front-end design and functionality of the original Instagram website while making it responsive to different screen sizes.",
    ...
    },
    {
      ...
      },
      {
        "status" : "completed",
        "category" : "front-end",
        "name" : "Bringing Instagram Design to Life",
      ...
      },
      {
        "status" : "completed",
        "category" : "rpa",
        "name" : "Web Data Extraction Project",
